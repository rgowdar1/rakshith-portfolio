...
export default function RootLayout({
  ...
  children: React.ReactNode;
    ...
    return (
      <html lang="en">
        <body className={`min-h-screen flex flex-col text-gray-100 ${geistSans.variable} ${geistMono.variable} font-sans`}>
          <header className="w-full py-3 px-2 sm:px-6 bg-black/60 backdrop-blur-md shadow-md sticky top-0 z-10">
            <div className="max-w-6xl mx-auto flex items-center justify-between">
              <span className="text-2xl font-bold tracking-tight text-white">Rakshith R</span>
              <nav className="flex items-center space-x-6">
                ...
                <a href="#experience" className="text-gray-200 hover:text-blue-400 transition">Experience</a>
                ...
                <a href="https://drive.google.com/file/d/176p90kPD0-mla9fSlw9fP2hgyLMXGd_I/view?usp=drive_link" target="_blank" rel="noopener noreferrer" className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-4 py-2 rounded-full hover:from-blue-700 hover:to-purple-700 transition font-semibold text-sm">Resume</a>
              </nav>
            </div>
          </header>
          ...
          <footer className="w-full py-6 px-4 bg-black/60 backdrop-blur-md border-t text-center text-sm text-gray-300">
            <p className="mb-1">Website Designed & Developed by <strong>Rakshith R.</strong></p>
