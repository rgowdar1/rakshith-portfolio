    ...
    <div>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
            ...
            <div className="flex-1">
              <p className="text-lg text-gray-300 max-w-2xl">
                ...
                applications using React and TypeScript. I specialize in
                frontend performance optimization, micro-frontend architecture,
                and delivering enterprise-grade UI solutions, with solid backend
        ...
        <div className="space-y-6">
          <div className="bg-white/5 p-6 rounded-lg border border-gray-700">
            ...
            <ul className="list-disc list-inside text-gray-400 mt-2">
              <li>
                Designed and developed enterprise-scale LMS features using
                React, TypeScript, and Java.
              </li>
              <li>
                Built reusable Material UI components and improved UI
                consistency.
              </li>
              <li>
          ...
          <div className="bg-white/5 p-6 rounded-lg border border-gray-700">
            ...
            <ul className="list-disc list-inside text-gray-400 mt-2">
              ...
              <li>
                Resolved production bugs and delivered feature enhancements
                across multiple modules.
              </li>
              <li>
                Actively contributed to Agile ceremonies, driving sprint
                planning, estimations, and timely delivery of features.
              </li>
            </ul>
          </div>
            ...
            <ul className="flex flex-wrap gap-3">
              ...
              <li className="bg-gradient-to-r from-cyan-600 to-blue-600 text-white px-3 py-1 rounded-full shadow flex items-center gap-1 text-sm">
                <svg
                  ...
                  fill="currentColor"
                >
                  <path d="M12.006 5.938l-7.981 3.638-.236 10.626 8.217 3.799 8.217-3.799-.236-10.626-7.981-3.638zm0 1.574l6.844 3.133-.198 8.999-6.646 3.086-6.646-3.086-.198-8.999 6.844-3.133z" />
                </svg>{" "}
                Tailwind CSS
              </li>
              <li className="bg-gradient-to-r from-cyan-600 to-blue-600 text-white px-3 py-1 rounded-full shadow flex items-center gap-1 text-sm">
        ...
        <div className="bg-white/5 p-6 rounded-lg border border-gray-700">
          <div className="grid gap-8 md:grid-cols-2">
            ...
            <div className="bg-white/10 rounded-lg shadow p-6 border border-gray-700">
              ...
              <p className="text-gray-300 mb-2">
                Built analytical dashboards for a B2B sales intelligence
                platform.
              </p>
      ...
      <section id="contact" className="mb-16">
        ...
        <div className="flex items-center gap-6">
          {/* Email Button */}
          <a
            href="mailto:rakshith.rg24@gmail.com"
            className="inline-block bg-blue-600 text-white p-3 rounded-full font-semibold hover:bg-blue-700 transition"
            title="Email"
          >
            <img
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-block bg-gradient-to-r from-purple-600 to-pink-600 text-white px-8 py-3 rounded-full font-semibold hover:from-purple-700 hover:to-pink-700 transition flex items-center gap-2"
          >
            <svg
              className="w-5 h-5"
              fill="none"
